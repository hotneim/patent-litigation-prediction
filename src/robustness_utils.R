...
# This part requires the full data file which is too large to host on github.
...
#
#   variables <-
#     readxl::read_excel(here("data", "variables_revision.xlsx")) %>%
...
#       write_csv(file = paste0(here(output_folder), "/robustness-", t0, ".csv"))
#
#   } else {
