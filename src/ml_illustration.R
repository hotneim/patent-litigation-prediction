...
ggsave("../../latex/material/revision_illustration_lr.pdf", ill_plot_lr)
ggsave("../../latex/material/revision_illustration_xgb.pdf", ill_plot_xgb)


## --- Repeat but for a simple example ------


dat1 <- tibble(x1 = 5*rnorm(n), x2 = .3*x1 - .7 + .5*rnorm(n), pop = "Population 1")
dat2 <- tibble(x1 = 5*rnorm(n), x2 = .3*x1 + .7 + .5*rnorm(n), pop = "Population 2")
...
ggsave("../../latex/material/revision_illustration_simple_lr.pdf", ill_plot_lr)
ggsave("../../latex/material/revision_illustration_simple_xgb.pdf", ill_plot_xgb)
